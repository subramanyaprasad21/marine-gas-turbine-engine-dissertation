...
MODEL_FILES = {'Fuel_flow_mf_kg/s': 'rf_Fuel_flow_mf_kg_s.pkl', 'GT_Turbine_decay_state_coefficient': 'rf_GT_Turbine_decay_state_coefficient.pkl', 'GT_Compressor_decay_state_coefficient': 'rf_GT_Compressor_decay_state_coefficient.pkl'}
MODELS = {}
